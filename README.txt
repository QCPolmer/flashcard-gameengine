...
The idea of the engine was rapid-prototyping 
	...
	(javascript/c, text only, runs on terminal and html)
...
-- 'dkjs' in examples can be used as a level editor 
	(run with 'dkjs -le' in a game file, like in z_examples)
	Requires compiling it
-- The '3d' stuff is experimental and not recommend to use
